...
def minimax(turn, overall_turn, depth, eval, maximising=True, alpha=-1000000, beta=1000000):
    ...
    for pos_move in pos_moves:
        ...
        value = minimax('W' if turn == 'B' else 'B', overall_turn,
                        depth - 1, new_eval, not maximising, alpha, beta)[0]
        if maximising:
            if value > bestValue:
                bestValue = value
                best_move = pos_move
